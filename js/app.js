(function ($) {
  ...
  App.getStats = function(){
    $.getJSON("/proxy_varnish_dashboard/stats", function(data){
  ...
  App.getBackendRequests = function() {
    $.getJSON("/proxy_varnish_dashboard/log/1/TxHeader/X-Full-Uri", function(data){
      var tmp_obj = {}
  ...
  App.calcHitRatio = function(){
    if (typeof App.newStats.client_req === 'undefined') {
      App.newStats.client_req = { "value": 0,};
    }
    if (typeof App.oldStats.client_req === 'undefined') {
      App.oldStats.client_req = { "value": 0,};
    }
    if (typeof App.newStats.cache_hit === 'undefined') {
      App.newStats.cache_hit = { "value": 0,};
    }
    if (typeof App.oldStats.cache_hit === 'undefined') {
      App.oldStats.cache_hit = { "value": 0,};
    }
  ...
  App.updateBandwidthGauge = function(){
    if (typeof App.newStats.s_hdrbytes === 'undefined') {
      App.newStats.s_hdrbytes = { "value": 0,};
    }
    if (typeof App.oldStats.s_hdrbytes === 'undefined') {
      App.oldStats.s_hdrbytes = { "value": 0,};
    }
    if (typeof App.newStats.s_bodybytes === 'undefined') {
      App.newStats.s_bodybytes = { "value": 0,};
    }
    if (typeof App.oldStats.s_bodybytes === 'undefined') {
      App.oldStats.s_bodybytes = { "value": 0,};
    }
